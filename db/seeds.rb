...
Session.destroy_all
session1 = Session.create(instructor: instructor1, start_time:"2018-01-02 19:00:46Z", end_time:"2018-01-02 20:00:46Z")
session2 = Session.create(instructor: instructor2, start_time:"2018-01-03 19:00:46Z", end_time:"2018-01-03 20:00:46Z")
session3 = Session.create(instructor: instructor1, start_time:"2018-01-02 21:00:46Z", end_time:"2018-01-02 22:00:46Z")



Reservation.destroy_all
reservation1 = Reservation.create(student: student1, session_id: session1.id)
reservation2 = Reservation.create(student: student1, session_id: session2.id)
reservation3 = Reservation.create(student: student2, session_id: session1.id)
